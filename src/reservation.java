...
public class reservation extends passenger
{
    ...
    static File r_file=new File("lib//Reservations.txt");   
    static String r_details[]={"TICKET NUMBER","FLIGHT NAME","FLIGHT NUMBER","SOURCE","DESTINATION","ADHAR NUMBER","PASSPORT NUMBER","DATE","DEPARTURE TIME","CLASS(First/Economy)","TYPE OF TRAVEL(International/Domestic)","FARE","STATUS"};
